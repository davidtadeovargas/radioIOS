...
class URLS{
    ...
    static let RADIOS_LIST_WITH_PAGING_PARAMS = HOST + "api/api.php?method=getRadios&api_key=eHJhZGlvcGVyZmVjdGFwcA&offset=%offset%&limit=%limit%&radio_id=&q=%q%&genre_id="
